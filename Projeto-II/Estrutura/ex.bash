...
eabi-gcc handler.c -o handler.o && eabi-gcc sdc.c -o sdc.o && eabi-gcc t.c -o t.o && eabi-as irq.s -o irq.o && eabi-ld -T irqld.ld irq.o handler.o -o irq.elf && eabi-bin irq.elf irq.bin && qemu irq.bin